...
const FleetCard = ({post:{image, destination, postedBy, _id, title, save}}) => {
   ...
   return (
      <div 
         className='m-5 relative cursor-pointer w-auto rounded-lg overflow-hidden bg-white'
      ...
      >
         <div className="flex items-center justify-between p-1">
            <a
               ...
               download
            >
               <FaDownload className='text-secColor'/>
            </a>
            {
               alreadySaved 
         ...
         <div className='realtive w-full' onClick={() => navigate(`/fleet-detail/${_id}`, {replace: true})}>
            <img 
